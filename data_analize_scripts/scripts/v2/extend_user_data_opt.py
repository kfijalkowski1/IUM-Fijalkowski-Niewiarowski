...
play_data = play_data.merge(user_stats[['user_id', 'avg_percent_played']], on='user_id', how='left')
...
output_sessions_path = './data_analize_scripts/dane/v2/sessions_with_skip_like_and_duration_info_test_opt.jsonl'
play_data[['timestamp', 'user_id', 'track_id', 'action', 'session_id', 'duration_time', 'percent_played', 'liked', 'skipped', 'avg_percent_played']].to_json(output_sessions_path, orient='records', lines=True)
