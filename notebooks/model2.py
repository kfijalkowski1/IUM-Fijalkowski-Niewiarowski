...
balanced_data_100 = data_100.sample(frac=0.3, random_state=42)  # Zachowujemy tylko 30% przypadków 100%
...
model_file_path = './models/v1/random_forest_regressor_undersampling.pkl'
